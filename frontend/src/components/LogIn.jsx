  ...
  return (
    <>
      <div className="flex flex-col justify-center text-white mt-32 items-center w-full px-10">
        <p className="mb-10 text-lg w-full">Please LogIn to your account</p>
        ...
        <Link className="w-full" to="/SignUp">
          <button className="w-full text-amber-300 ring-2 focus:outline-none ring-amber-300 font-medium rounded-lg text-sm sm:w-auto py-2.5 text-center">
            Sign Up
          </button>
        </Link>
      </div>
